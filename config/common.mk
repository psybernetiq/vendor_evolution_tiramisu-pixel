...
# Disable rescue party for Pixel 5, otherwise it will reboot to recovery within ~10seconds after welcome screen appears
TARGET_IS_PIXEL_5 ?= false
ifeq ($(TARGET_IS_PIXEL_5), true)
PRODUCT_PRODUCT_PROPERTIES += \
